...
- [ ] Reproduced first: at 1920x1080 the frame on Tables is narrower than on Market Setup, and a long market name is cut.
- [ ] Every market screen's frame is the same width at 1920x1080 and 1280x800.
- [ ] A long market name is shown whole wherever it fits, and ellipsed (with its full name on hover) only where it does not.
- [ ] `docs/design-system.md` says which width a market screen is.
